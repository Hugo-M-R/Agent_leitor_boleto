"""CLI simples para extrair vencimento/infos de pagamentos a partir de arquivos.

Uso:
    python -m agents.vencimento_agent caminho/do/arquivo.pdf|.jpg|.png|.txt
    type arquivo.txt | python -m agents.vencimento_agent -

Gera arquivos em `retornos/` com os resultados e a transcrição quando inédito.
"""
...
try:
	# Execução no container: diretório raiz montado em /app contém facade.py
	from facade import (
	...
	# Execução quando o projeto é instalado/impresso como pacote 'agentics'
...
def main() -> None:
    """Ponto de entrada do CLI: resolve entrada, extrai e grava resultados."""
	import argparse
