"""Carrega configurações do ambiente para o pacote (OCR, paths, etc.)."""

import os


class Settings:
    """Estrutura de configurações parametrizada por variáveis de ambiente."""
...
def get_settings() -> Settings:
    """Instancia e retorna `Settings` com valores atuais do ambiente."""
    return Settings()
